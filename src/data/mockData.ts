...
export const patients: Patient[] = [
  {
    ...
    parentDetails: [],
    therapistDetails: [
      { therapistId: 'THR-001', therapistName: 'Meera Singh', isPrimary: true },
    ],
  ...
  },
  {
    ...
    parentDetails: [],
    therapistDetails: [
      { therapistId: 'THR-002', therapistName: 'Pooja Nath', isPrimary: true },
    ],
  ...
  },
  {
    ...
    dob: '1990-11-12',
    gender: 'Female',
    email: 'neha.gogoi@email.com',
    address: 'Silpukhuri, Guwahati',
    pinCode: '781003',
    state: 'Assam',
    district: 'Kamrup',
    enquirySource: 'Instagram',
    parentDetails: [],
    therapistDetails: [],
  ...
  },
  {
    ...
    dob: '1983-08-05',
    gender: 'Male',
    email: 'bikash.saikia@email.com',
    address: 'Chandmari, Guwahati',
    pinCode: '781003',
    state: 'Assam',
    district: 'Kamrup',
    enquirySource: 'Google Ads',
    parentDetails: [],
    therapistDetails: [],
...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    department: 'Hair',
    qualification: 'MBBS, DV&D, Trichology Certified',
    available: true,
    consultFee: 600,
    location: 'Room 2, 2nd Floor',
    workingDays: ['Mon', 'Tue', 'Wed', 'Fri', 'Sat', 'Sun'],
    workingHours: { start: '10:00', end: '19:00' },
  },
  {
...
export const appointments: Appointment[] = [
  // Today's Appointments
  {
    ...
    startTime: '10:00',
    endTime: '10:30',
    appointmentType: APPOINTMENT_TYPE.FOLLOWUP,
    serviceType: SERVICE_TYPE.HAIR,
    visitType: VISIT_TYPE.CLINIC,
    therapistId: 'THR-001',
    therapistName: 'Meera Singh',
    isPackage: true,
    packageId: 'PKG-001',
    prePaymentRequired: false,
    prePaymentAmount: 0,
    status: APPOINTMENT_STATUS.CONFIRMED,
    leadStatus: LEAD_STATUS.REGISTERED,
    remark: 'PRP session 5 of 10',
    createdAt: now(),
    updatedAt: now(),
  },
  {
    ...
    startTime: '11:00',
    endTime: '11:30',
    appointmentType: APPOINTMENT_TYPE.NEW,
    serviceType: SERVICE_TYPE.SKIN,
    visitType: VISIT_TYPE.CLINIC,
    therapistId: 'THR-002',
    therapistName: 'Pooja Nath',
    isPackage: false,
  ...
  },
  {
    id: 'APT-003',
    patientId: 'PAT-003',
    patientName: 'Amit Bora',
    patientMobile: '7001234567',
    doctorId: 'DOC-003',
    doctorName: 'Dr. Ananya Bose',
    date: today(),
    startTime: '14:00',
    endTime: '15:00',
    appointmentType: APPOINTMENT_TYPE.PACKAGE,
    serviceType: SERVICE_TYPE.HAIR_TRANSPLANT,
    visitType: VISIT_TYPE.CLINIC,
    isPackage: false,
    prePaymentRequired: true,
    prePaymentAmount: 5000,
    status: APPOINTMENT_STATUS.PAID,
    leadStatus: LEAD_STATUS.CONVERTED,
    remark: 'FUE procedure — 1200 grafts',
    createdAt: now(),
    updatedAt: now(),
  },
  {
    id: 'APT-004',
    patientId: 'PAT-004',
    patientName: 'Sunita Kalita',
    patientMobile: '8001234567',
    doctorId: 'DOC-001',
    doctorName: 'Dr. Sarah Paul',
    date: today(),
    startTime: '15:30',
  ...
  },
  {
    id: 'APT-005',
    patientId: 'PAT-006',
    patientName: 'Neha Gogoi',
    patientMobile: '9435012345',
    doctorId: 'DOC-001',
    doctorName: 'Dr. Sarah Paul',
    date: today(),
    startTime: '16:30',
  ...
  },
  {
    id: 'APT-006',
    patientId: 'PAT-005',
    patientName: 'Dipankar Roy',
    patientMobile: '6001234567',
    doctorId: 'DOC-002',
    doctorName: 'Dr. Rajesh Kumar',
    date: today(),
    startTime: '17:30',
    ...
    appointmentType: APPOINTMENT_TYPE.NEW,
    serviceType: SERVICE_TYPE.HAIR,
    visitType: VISIT_TYPE.HOME,
    isPackage: false,
    prePaymentRequired: false,
    prePaymentAmount: 0,
    status: APPOINTMENT_STATUS.SCHEDULED,
    leadStatus: LEAD_STATUS.NEW,
    remark: 'Home visit — scalp evaluation',
    createdAt: now(),
    updatedAt: now(),
  },
  ...
  },
  {
    id: 'APT-008',
    patientId: 'PAT-007',
    patientName: 'Bikash Saikia',
    patientMobile: '9864098765',
    doctorId: 'DOC-003',
    doctorName: 'Dr. Ananya Bose',
    date: dayOffset(-1),
    startTime: '11:00',
    endTime: '12:00',
    appointmentType: APPOINTMENT_TYPE.NEW,
    serviceType: SERVICE_TYPE.COSMETIC,
    visitType: VISIT_TYPE.CLINIC,
    isPackage: false,
    prePaymentRequired: false,
    prePaymentAmount: 0,
  ...
  },
  {
    ...
    leadStatus: LEAD_STATUS.CONVERTED,
    remark: 'Patient requested rescheduling',
    createdAt: now(),
    updatedAt: now(),
  },
  {
...
export const currentStaff: StaffUser = {
  ...
  role: 'Receptionist',
  staffId: 'DRP-R-0042',
  email: 'anjali@drpaulsclinic.com',
  mobile: '9000000001',
};

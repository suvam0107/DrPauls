...
import { AuthState, UserProfile, MockUser } from '../types';
...
const useAuthStore = create<AuthState>((set, get) => ({
   ...
   */
  checkAndVerifyAuth: async (): Promise<boolean> => {
    try {
   ...
   */
  refreshAuthTokenForUser: async (userObj: UserProfile): Promise<string | null> => {
